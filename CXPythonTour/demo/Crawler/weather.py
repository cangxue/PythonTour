...
#     f = open("weather_txt.txt", "w")
#     f.write(filename)
#     f.write("\n")
#     title = '数据分别为时间，AQI指数，PM2.5，PM10，CO，NO2，SO2，O3。（单位：μg/m3，CO为mg/m3）'
#     f.write(title)
#     f.write("\n")
#     f.write(datatime[0])
#     f.write(",")
...
#         # print(data)
#         # 构建数据收集的表达式
#         data_weather = '<dd class="weather.*?<span><b>(.*?)</b>(.*?)</span>'
