#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# 参考文件：https://foofish.net/python-crawler-html2pdf.html

# 工具准备
# pip install requests 网络请求
# pip install beautifulsoup4 操作html数据
# pip install pdfkit  pdfkit 是 wkhtmltopdf 的Python封装包，html 到 pdf 的转换
...
class LiaoxuefengPythonCrawler(Crawler):
    ...
    def parse_body(self, response):
        ...
        try:
            ...
            html = re.compile(pattren).sub(func, html)
